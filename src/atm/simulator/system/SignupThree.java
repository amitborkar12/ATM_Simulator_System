...
public class SignupThree extends JFrame implements ActionListener
{
	...
	SignupThree( String formno)
	{
		...
		c6.setBounds(100,600,200,20);
		add(c6);
		
		c7= new JCheckBox("I Hereby declare that the above entered details are correct to the bestbof knowledge");
	...
	public  void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()== submit )
		{
			...
			try
			{
				...
				{ 
				   Conn c = new Conn();
				   String query1 = "insert into bankmanagementsystem.signupthree values ('"+formno+"','"+accountType+"','"+cardnumber+"','"+pinnumber+"','"+facility+"')";
